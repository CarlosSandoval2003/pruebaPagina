...
const ProductDisplay = (props) => {
  ...
  useEffect(() => {
    ...
    fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/firstOption/${props.id}`)
  ...
  useEffect(() => {
    ...
    if (selectedOption1) {
      if (tipos.length > 1) {
        fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/secondOption/${selectedOption1}/${props.id}`)
          .then(response => response.json())
          .then(data => {
        ...
        const opcion2 = "0";
        fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/configurationProduct/${selectedOption1}/${opcion2}/${props.id}`)
          .then(response => response.json())
          .then(data => {
  ...
  const handleSelectOption2 = (e) => {
    ...
    fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/checkAvailability/${props.id}/${selectedValue}/${selectedOption1}`)
      .then(response => response.json())
      .then(data => {
        if (data.available) {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const cartResponse = await fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/cart/${userId}`);
      const cartData = await cartResponse.json();

      let cartId;
      // Si no hay un carrito existente, crear uno nuevo
      if (!cartData.cartExists) {
        const newCartResponse = await fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/cart`, {
          method: "POST",
          headers: {
    ...
    console.log("TIPOS EN ADD CARRITO:",tipos);
      ...
      if (tipos.length > 1) {
        const configurationResponse = await fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/configurationProduct/${selectedOption1}/${selectedOption2}/${props.id}`);
      ...
      const cartItemResponse = await fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/cartItem/${cartId}/${itemId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (cartItemData.success) {
        ...
        const configurationResponse = await fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/configurationProduct/${selectedOption1}/0/${props.id}`);
        const configurationData = await configurationResponse.json();
        const itemId = configurationData.itemId;
        console.log(itemId, cartId);
  ...
  useEffect(() => {
    if (selectedOption1 && selectedOption2) {
      fetch(`https://1ab1-2800-98-1116-780-f9ba-be07-9e81-945e.ngrok-free.app/configurationProduct/${selectedOption1}/${selectedOption2}/${props.id}`)
        .then(response => response.json())
        .then(data => {
          setPrice(data.price); // Establecer el precio del producto
        })
    ...
    <div className="productdisplay">
      <div className="productdisplay-left">
        ...
        <div className="productdisplay-img">
          <img className="productdisplay-main-img" src={props.image1} alt="img" />
        </div>
      </div>
